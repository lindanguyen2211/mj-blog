...
const Articles = () => {
  const articles = [
    {
      id: 1,
      title: "Accuracy of the maxillomandibular relationship at centric relation position recorded by using 3 different intraoral scanners and MODJAW",
      date: "June 27, 2025",
    ...
    {
      id: 3,
      title: "The FAS Aligner System and the treatment of temporomandibular disorder",
      date: "June 29, 2025",
    ...
    {
      id: 7,
      title: "MANAGE THE DYNAMIC OCCLUSION OF IMPLANT RESTORATIONS IN A DIGITAL WORKFLOW",
      date: "July 2, 2025",
      pdf: "ARTICLE_NOT FREE_MANAGE THE DYNAMIC OCCLUSION OF IMPLANT RESTORATIONS IN A DIGITAL WORKFLOW"
    },
    {
      id: 8,
      title: "Modjaw in daily orthodontic practice: about a case treated with FAS aligners",
      date: "July 2, 2025",
    ...
    {
      id: 10,
      title: "Fully digital workflow for the fabrication of occlusal stabilization splints",
      date: "July 2, 2025",
    ...
    {
      id: 12,
      title: "Thesis US Air Force: Mandibular Movement in 4D Accuracy of a Digital Mandibular Movement",
      date: "July 2, 2025",
